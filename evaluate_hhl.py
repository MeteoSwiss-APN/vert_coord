...
# python evaluate_hhl.py --grid_file /store/s83/swester/grids/alps_R19B08/alps_DOM01.nc --model icon --print_hhl --lev 35 --loc mtblanc
#   --loc sav --loc zrh --loc ulr --file /store/s83/swester/daint/const_sleve.nc
# python evaluate_hhl.py --model icon --file /store/s83/swester/teamx/tdf_2019091212/output/19091212/lfff00000000c.nc
